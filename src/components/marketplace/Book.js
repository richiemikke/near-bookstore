...
const Book = ({ book, buy, addAvailable, editPrice, editDescription, likebook, isOwner}) => {
  const { id, price, available, author, title, description, sold, image, owner, likes } = book;
